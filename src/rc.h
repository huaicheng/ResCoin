...
int set_schedinfo(virDomainPtr domain, virTypedParameterPtr *params, int *nparams);

int set_cpu_shares(virDomainPtr domain, const char *cpu_shares);

int set_cpu_shares_ull(virDomainPtr domain, uunsigned long long *cpu_shares);
...
int set_vcpu_quota_ll(virDomainPtr domain, const char *vcpu_quota);
...
int get_vcpu_bw(virDomainPtr domain, unsigned long long *vcpu_period, long long *vcpu_quota);
